/*
 * Creater: Mixixix(TingouWu)
 * Last Builder: 2016/05/23 12:37  (GMT + 8:00)
 * Last Builder: Mixixix(TingouWu)
 * Using: Main Controler 
 */
#include <PS2X_lib.h>  //Load PS2 Remote Lib
#include <stdio.h> //System Lib
#include <math.h> //System Lib
#include "Wire.h" //Wire Control Lib
#include "I2Cdev.h" //Control Lib For I2C Com
#include "MPU6050.h" //Control Lib For MPU6050
MPU6050 accelgyro; //Start MPU6050
...
int lf = 6; //Left Front PIN Code
int lb = 9; //Left Behind PIN Code
int rf = 5; //Right Front PIN Code
int rb = 3; //Right Behind PIN Code
